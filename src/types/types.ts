...
export interface EternityNode {
  ...
  owned: boolean;
  effect: number;
  type: 'omnipotent' | 'transcendenceMulti' | 'infiniteAuto' | 'beyondReality' | 'timeless';
}
