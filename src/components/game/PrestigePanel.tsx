...
import { calculatePrestigeGain, calculateAscensionGain } from '@/hooks/useGameState';
...
function SkillNodeButton({ node, points, onBuy, color = 'yellow' }: { node: SkillNode; points: number; onBuy: () => void; color?: 'yellow' | 'purple'; }) {
